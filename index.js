...
const formatBirthYear = (born) => {
    ...
    if (typeof born === 'string' && born.toUpperCase().includes('BBY')) {
        return born.toUpperCase();
    }
...
function renderPage() {
    ...
    const totalPages =
        Math.ceil(allCharacters.length / itemsPerPage) || 1;
    ...
    characters.forEach(character => {
        ...
        if (brokenImages.includes(character.name) || !imageUrl) {
        ...
        const btnClass = isSelected
            ...
            : "bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold";
        ...
        characterListDiv.innerHTML += `
            ...
            <div class="bg-slate-900/80 backdrop-blur-sm border ${isSelected ? 'border-yellow-400 scale-[1.02]' : 'border-slate-700'} rounded-2xl p-4 hover:scale-105 hover:border-yellow-400 transition duration-300 flex flex-col justify-between shadow-md">
                ...
                <div>
                    ...
                    <h2 class="text-base font-bold text-center text-yellow-400 capitalize mb-3">
                        ${character.name}
                    </h2>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <button
                        onclick="toggleSelectCharacter(${character.id})"
                    ...
                    <div class="text-slate-400 text-[11px] text-center border-t border-slate-700 pt-2">
                        ...
                        <p>
                            ...
                            <span>${translate(character.species)}</span>
                        </p>

                        <p>
                            <span class="text-slate-500">Origen:</span>
                            <span>${character.homeworld || 'Desconocido'}</span>
                        </p>
...
window.toggleSelectCharacter = function(id) {
    ...
    const index =
        selectedCharacters.findIndex(c => c.id === id);
...
function renderComparison() {
    ...
    if (selectedCharacters.length === 2) {
        ...
        const img1 = brokenImages.includes(char1.name)
            ? defaultSpaceImage
            : char1.image;

        const img2 = brokenImages.includes(char2.name)
            ? defaultSpaceImage
            : char2.image;
        ...
        comparisonSection.innerHTML = `
            ...
            <div class="w-[98%] md:w-[1300px] max-w-7xl bg-slate-950 rounded-2xl p-8 border-2 border-yellow-500 shadow-[0_0_25px_rgba(234,179,8,0.2)] relative max-h-[95vh] overflow-y-auto animate-modal">
                ...
                <button 
                    ...
                    class="absolute top-4 right-4 text-slate-400 hover:text-white text-2xl cursor-pointer transition"
                >
                    ✕
                </button>

                <h2 class="text-2xl md:text-3xl font-bold text-center text-yellow-400 mb-8 flex items-center justify-center gap-2">
                    <span>📊</span>
                    ...
                    <table class="w-full text-left border-collapse table-fixed text-base">
                        ...
                        <thead>
                            ...
                            <tr class="border-b border-slate-800">
                                ...
                                <th class="py-4 px-6 text-slate-400 font-medium uppercase tracking-wider text-xs w-1/3">
                                    Personaje
                                </th>

                                <th class="py-4 px-6 text-yellow-400 font-bold text-center text-lg w-1/3">
                                    ${char1.name}
                                </th>
                        ...
                        <tbody class="divide-y divide-slate-800/50">
                            ...
                            <tr>
                                ...
                                <td class="py-6 px-6">
                                    ...
                                    <div class="w-36 h-36 mx-auto bg-slate-900/60 rounded-2xl border border-slate-800 flex items-center justify-center overflow-hidden">
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-bold text-lg">
                                    ${formatHeight(char1.height)}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-bold text-lg">
                                    ${formatHeight(char2.height)}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${char1.mass ? char1.mass + ' kg' : 'Desconocido'}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${char2.mass ? char2.mass + ' kg' : 'Desconocido'}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char1.gender)}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char2.gender)}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char1.hairColor)}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char2.hairColor)}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-bold text-lg">
                                    ${formatBirthYear(char1.born)}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-bold text-lg">
                                    ${formatBirthYear(char2.born)}
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char1.species)}
                                </td>

                                <td class="py-4 px-6 text-center text-white font-medium text-lg">
                                    ${translate(char2.species)}
                                </td>
                ...
                <div class="mt-8 flex justify-end">
                    ...
                    <button
                        onclick="clearComparison()"
                        class="bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-white text-sm uppercase tracking-wider px-6 py-3 rounded-xl font-bold border border-slate-800/80 cursor-pointer transition"
                    >
                        Cerrar y Limpiar
                    </button>
