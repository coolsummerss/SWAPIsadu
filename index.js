            ...
            <div class="bg-slate-900/80 backdrop-blur-sm border ${isSelected ? 'border-yellow-400 scale-[1.02]' : 'border-slate-700'} rounded-2xl p-4 hover:scale-105 hover:border-yellow-400 transition duration-300 flex flex-col justify-between shadow-md">
                <div>
                    <div class="w-full h-72 flex items-center justify-center bg-slate-950/40 rounded-xl mb-4 overflow-hidden">
                        <img class="max-w-full max-h-full object-contain" src="${imageUrl}" alt="${character.name}" onerror="this.src='./default.png';">
                    </div>
                    <h2 class="text-base font-bold text-center text-yellow-400 capitalize mb-3">${character.name}</h2>
                </div>
                    <div class="flex flex-col gap-3">
                     ...
                     <button onclick="toggleSelectCharacter(${character.id})"
                      ...
                      <a href="./detalle/index.html?id=${character.id}"
                     class="w-full text-center py-2 rounded-xl bg-slate-700 hover:bg-slate-600 text-white font-bold text-xs block transition">
                       Ver Detalle
    </a>
